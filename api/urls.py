...
urlpatterns = [
    ...
    path('make-review/', views.MakeReviewAPIList.as_view()),
    path('make-review/<int:pk>/', views.MakeReviewAPIDetailView.as_view()),
    ...
    path('chat/', views.ChatAPIList.as_view()),
    path('chat/<int:pk>/', views.ChatAPIDetailView.as_view()),
    path('message/', views.MessageAPIList.as_view()),
